...
public final class Constants {
    ...
    public static final String PLUGIN_NAME        = "JavaParser AST Inspector Shadow";
    public static final String TOOL_WINDOW_ID     = "JavaParser AST Inspector Shadow"; // see plugin.xml
    ...
    public static final String URL_GITHUB_PLUGIN     = "https://github.com/meiMingle/JavaParser-AST-Inspector";
